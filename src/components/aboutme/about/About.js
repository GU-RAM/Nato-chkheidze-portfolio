            ...
            <Fade duration={3000}>
              <p className="home-about-body">
                ...
                <b>
                  ...
                  ანატომია-ფიზიოლოგიას, ამიტომ ჩემი მოქმედებები ეფექტიანი და
                  უსაფრთხოა.
                </b>
                <br />
                <br />
                ...
                <b className="purple">
                  {" "}
                  37 წლიან მასაჟისტისა (31 უწყვეტი წელი) და მანამდე სამედიცინო
                  სფეროში მოღვაწეობას კალინინის ცენტრალურ საავადმყოფოში.
                </b>{" "}
                ...
                <b className="purple"> "ოქროს ხელების" ჯილდო კალინინში.</b>
                <br />
              </p>
            </Fade>
          </Col>
